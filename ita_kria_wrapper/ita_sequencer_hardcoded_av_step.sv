    ...
    always_comb begin
        ...
        case (current_state)
            ...
            S_WRITE_REQ_0: begin
                ...
                periph_wen_o = 1'b0; 
                case (write_step_cnt)
                    0:   begin periph_add_o = 32'd32; periph_data_o = 32'h37cc0; end // INPUT_PTR
                    1:   begin periph_add_o = 32'd36; periph_data_o = 32'h34cc0; end // WEIGHT_PTR0
                    2:   begin periph_add_o = 32'd40; periph_data_o = 32'h35cc0; end // WEIGHT_PTR1
                    3:   begin periph_add_o = 32'd48; periph_data_o = 32'h38cc0; end // OUTPUT_PTR
            ...
            S_WRITE_REQ_1: begin
                ...
                case (write_step_cnt)
                    0:   begin periph_add_o = 32'd32; periph_data_o = 32'h37cc0; end // INPUT_PTR
                    1:   begin periph_add_o = 32'd36; periph_data_o = 32'h35cc0; end // WEIGHT_PTR0
                    2:   begin periph_add_o = 32'd40; periph_data_o = 32'h36cc0; end // WEIGHT_PTR1
                    3:   begin periph_add_o = 32'd48; periph_data_o = 32'h39cc0; end // OUTPUT_PTR
                    4:   begin periph_add_o = 32'd84; periph_data_o = 32'h00000; end // TILES
                    5:   begin periph_add_o = 32'd88; periph_data_o = 32'h00006; end // EPS_MULT0
                endcase
            ...
            S_WRITE_REQ_2: begin
                ...
                case (write_step_cnt)
                    0:   begin periph_add_o = 32'd32; periph_data_o = 32'h37cc0; end // INPUT_PTR
                    1:   begin periph_add_o = 32'd36; periph_data_o = 32'h36cc0; end // WEIGHT_PTR0
                    2:   begin periph_add_o = 32'd40; periph_data_o = 32'h16000; end // WEIGHT_PTR1
                    3:   begin periph_add_o = 32'd48; periph_data_o = 32'h3acc0; end // OUTPUT_PTR
                    4:   begin periph_add_o = 32'd84; periph_data_o = 32'h00000; end // TILES
                    5:   begin periph_add_o = 32'd88; periph_data_o = 32'h00006; end // EPS_MULT0
                endcase
