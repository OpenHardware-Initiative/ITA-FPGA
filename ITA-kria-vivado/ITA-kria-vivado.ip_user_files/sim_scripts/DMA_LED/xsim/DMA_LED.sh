...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "TARGET_ITA_HWPE=" -d "TARGET_ITA_HWPE_TEST=" -d "TARGET_RTL=" -d "TARGET_SIMULATION=" -d "TARGET_TEST=" -d "TARGET_VSIM=" -d "NO_STALLS=0" -d "SINGLE_ATTENTION=0" -d "ITA_N=8" -d "ITA_M=64" -d "SEQ_LENGTH=64" -d "EMBED_SIZE=128" -d "PROJ_SPACE=192" -d "FF_SIZE=256" -d "BIAS=1" -d "ACTIVATION=Relu" -d "HCI_ASSERT_DELAY=#41ps"  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L zynq_ultra_ps_e_vip_v1_0_17 -L xil_defaultlib -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_10 -L lib_fifo_v1_0_19 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_33 -L axi_sg_v4_1_18 -L axi_dma_v7_1_32 -L proc_sys_reset_v5_0_15 -L xlconcat_v2_1_6 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_register_slice_v2_1_31 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_30 -L axi_crossbar_v2_1_32 -L xlslice_v1_0_4 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_13 -L axi_protocol_converter_v2_1_31 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DMA_LED xil_defaultlib.DMA_LED xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DMA_LED -key {Behavioral:sim_1:Functional:DMA_LED} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_9be7.protoinst" -protoinst "protoinst_files/DMA_LED.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DMA_LED.wdb xsim.dir libdpi.so)
