...
set genomeRtd $env(RT_TMP)/548DA020.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ita_hwpe_output_buffer__GC0}]"
...
set genomeName [subst -nocommands -novariables {ita_hwpe_output_buffer__GC0}]
