...
set genomeRtd $env(RT_TMP)/510A5F40.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {uram_memory_controller_ita_dma__GB8}]"
...
set genomeName [subst -nocommands -novariables {uram_memory_controller_ita_dma__GB8}]
