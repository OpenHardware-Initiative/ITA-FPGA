...
set genomeRtd $env(RT_TMP)/9FE91300.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {hwpe_stream_fifo}]"
...
set genomeName [subst -nocommands -novariables {hwpe_stream_fifo}]
