...
set genomeRtd $env(RT_TMP)/94501200.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {uram_memory_controller_ita_dma__GB6}]"
...
set genomeName [subst -nocommands -novariables {uram_memory_controller_ita_dma__GB6}]
